    ...
    <div className='maincategoria'>
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col contenedor">
              <img src={imagenMap.cattfacialessfaca} alt="tratamiento-facial-essential-face-care" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.cattfacialglowvitc} alt="tratamiento-facial-glowinf-vit-c" className="img" />
              <h4>Glowing Vit C+</h4>
              <p>
            ...
            <div className="col contenedor">
              <img src={imagenMap.cattfacialrebfaca} alt="tratamiento-facial-rebalancing" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.cattfacialglowr} alt="tratamiento-facial-glowing-roses" className="img" />
              <h4>Glowing Roses</h4>
              <p>
      ...
      <div>
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col contenedor">
              <img src={imagenMap.cattcorporalliwen} alt="tratamiento-corporal-ceremonia-liwen" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.cattcorporalragiantu} alt="tratamiento-corporal-ragiantu" className="img" />
      ...
      <div>
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col contenedor">
              <img src={imagenMap.catmasajesueco} alt="masaje-sueco" className="img" />
              <h4>Masaje Sueco</h4>
              <p>
            ...
            <div className="col contenedor">
              <img src={imagenMap.catmasajehots} alt="masaje-hot-stones" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.catmasajedtissue} alt="masaje-deep-tissue" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.catmasajesignature} alt="masaje-signature" className="img" />
      ...
      <div>
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col contenedor">
              <img src={imagenMap.cataromatepurif} alt="masaje-aromaterapia-purificante" className="img" />
              <h4>Purificante</h4>
              <p>
            ...
            <div className="col contenedor">
              <img src={imagenMap.cataromaterelaj} alt="masaje-aromaterapia-relajante" className="img" />
              <h4>Relajante</h4>
              <p>
            ...
            <div className="col contenedor">
              <img src={imagenMap.cataromateestim} alt="masaje-aromaterapia-estimulante" className="img" />
              <h4>Estimulante</h4>
              <p>
      ...
      <div>
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col contenedor">
              <img src={imagenMap.catritualnirvesc} alt="ritual-nirvana-escape" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.catritualminds} alt="ritual-mind-soul" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.catritualafflora} alt="ritual-afflora" className="img" />
            ...
            <div className="col contenedor">
              <img src={imagenMap.catritualmulfem} alt="ritual-mulfem" className="img" />
              <h4>Ritual Mülfem</h4>
              <p>
            ...
            <div className="col contenedor">
              <img src={imagenMap.catritualunad} alt="ritual-unad" className="img" />
              <h4>Ritual Üñad</h4>
              <p>
                <strong
            ...
            <div className="col contenedor">
              <img src={imagenMap.catritualurkutun} alt="ritual-urkutun" className="img" />
