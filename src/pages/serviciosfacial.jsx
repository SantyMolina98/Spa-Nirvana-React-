...
import STF1 from '../assets/Img/STF1.jpg';
import STF2 from '../assets/Img/STF2.JPG';
import STF3 from '../assets/Img/STF3.JPG';
                ...
                <div id="carouselExampleCaptions" className="carousel slide">
                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <img src={STF1} className="d-block w-100" alt="STF1" height="750vh" />
                      <div className="carousel-caption d-none d-md-block">
                        <h5 style="color: black;">Essential Face Care</h5>
                      </div>
                    </div>
                    <div className="carousel-item">
                      <img src={STF2} className="d-block w-100" alt="STF2" height="750vh" />
                      <div className="carousel-caption d-none d-md-block">
                      <h5 style="color: black;">Rebalancing Face Care</h5>
                    </div>
                  </div>
                  <div className="carousel-item">
                    <img src={STF3} className="d-block w-100" alt="stf3" height="750vh" />
                    <div className="carousel-caption d-none d-md-block">
