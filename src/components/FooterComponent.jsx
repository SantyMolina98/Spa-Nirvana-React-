...
//                     <Link to="*" className="nav-link p-0 text-body-secondary"><p className='p-footer'>Atención al Cliente - 0381 5783 030</p></Link>
//                   </li> 
//                   <li className="li-column2">
//                     <Link to="*" className="nav-link p-0 text-body-secondary"><p className='p-footer'>Trabaja con Nosotros <i className="bi bi-linkedin"></i>
//                       </p>
//                     </Link>
//                   </li> 
//                   <li className="nav-item mb-2">
//                     <Link to="/contacto" className="nav-link p-0 text-body-secondary"><p className='p-footer'>Contáctanos</p></Link>
//                   </li> 
//                   <li className="nav-item mb-2">
...
//           <Link to="*" className="visitado" target="_blank"><i className="bi bi-whatsapp"></i></Link>
//         </div>
//       </div>  
      ...
      <Container>
        <Row className="pb-4 mb-4 border-bottom align-items-start">
          <Col xs={12} lg={4} className="mb-4 mb-lg-0 text-center">
            ...
            />
            <h5 className="text-uppercase mb-2 text-white">Síguenos</h5>
          ...
          <Col xs={12} md={6} lg={4} className="mb-4 mb-lg-0">
            <h5 className="text-uppercase mb-3 text-white">Nuestros Datos</h5>
            <ListGroup variant="flush" className="bg-transparent">
              ...
              <ListGroup.Item className="bg-transparent border-0 ps-0 pb-2">
                <a href="URL_GOOGLE_MAPS" target="_blank" rel="noopener noreferrer" className="text-white p-footer-link">
                  <i className="bi bi-geo-alt-fill me-2"></i>Gral. José María Paz 576, <br/> San Miguel de Tucumán, Tucumán
                </a>
              </ListGroup.Item>
            </ListGroup>
          </Col>
