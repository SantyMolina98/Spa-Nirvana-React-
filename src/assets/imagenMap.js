...
import logospaheader from './Img/logospaheader.png';
...
import publicidad50off from './Img/publicidad50off.jpg';
...
import categoriarituales from './Img/categoriarituales.jpg';
import catritualafflora from './Img/catritualafflora.jpg';
...
const imagenMap = {
  ...
  logospaheader,
      //Promos  
      promo1,   promo2,   promo3,    promo4,   publicidad50off,
      //Grid
      grid1tratamientos,    grid2masajes,   grid3rituales,
  //Categorías
  categoriatfacial,
  cattfacialessfaca,
  cattfacialglowr,
  ...
  categoriatcorporal,
  cattcorporalliwen,
  cattcorporalragiantu,
  categoriamasaje,
  catmasajedtissue,
  catmasajehots,
  catmasajesignature,
  catmasajesueco,
  categoriaaromaterapia,
  cataromateestim,
  cataromatepurif,
  cataromaterelaj,
  categoriarituales,
